    ...
    return (
        ...
        >
            <div className="p-6 max-w-lg w-full bg-white bg-opacity-80 rounded-lg shadow-lg">
                <p className="text-center text-2xl font-cinzel font-semibold">Delivery Sign Up</p>
                <form className="flex flex-col gap-4 mt-5" onSubmit={handleSubmit}>
                    ...
                    <div>
                        ...
                        <TextInput type="number" placeholder="Age" id="age" onChange={handleChange} />
                    </div>
                    <div>
                        <Label value="Your ID number" />
                        <TextInput type="text" placeholder="ID Number" id="idNumber" onChange={handleChange} />
                    </div>
                    <div>
